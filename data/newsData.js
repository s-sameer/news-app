export const dummyArticles = [
  {
    ...
    description:
      "A team of international researchers has discovered a previously unknown species of amphibian in the depths of the Amazon rainforest. The new species, named Amazonian glass frog, has translucent skin that reveals its internal organs.",
  ...
  <p>The research team will continue their work in the region, hoping to identify more previously unknown species before they potentially disappear due to human activities.</p>`,
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1599940824399-b87987ceb72a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
  },
  {
    id: 2,
    title: "Global Tech Conference Announces Revolutionary AI Framework",
    description:
      "TechWorld 2025 Conference unveiled a new open-source AI framework that promises to democratize access to advanced artificial intelligence tools for developers worldwide.",
  ...
  },
  {
    ...
    description:
      "The GreenCity Project has completed its first phase, converting 30% of urban infrastructure to sustainable alternatives and reducing carbon emissions by 45%.",
  ...
  },
  {
    id: 4,
    title:
      "Global Economy Shows Signs of Stable Growth After Pandemic Recovery",
    description:
      "Economic indicators point to sustained growth across major economies as post-pandemic recovery measures show lasting positive effects.",
  ...
  },
  {
    ...
    description:
      "The World Heritage Arts Festival opened this week featuring works from over 60 countries, highlighting traditional and contemporary expressions of cultural identity.",
  ...
  <p>The World Heritage Arts Festival continues for three weeks, with rotating exhibitions and daily performance schedules available on the festival's website.</p>`,
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
  },
  {
    id: 6,
    title: "New Health Study Reveals Benefits of Intermittent Exercise",
    description:
      "Research published in the Medical Journal of Health Sciences suggests that short bursts of activity throughout the day may be more beneficial than single longer workouts.",
